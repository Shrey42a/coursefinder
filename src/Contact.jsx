...
function Contact(){
    return(
        ...
        <Link to="/" className='lg:relative -top-10 lg:top-1 -ml-56 lg:-ml-96 lg:right-96'><img src='/bck.svg' className='lg:h-10 lg:w-10 w-5 h-5 scale-75'></img></Link>
         <div className="lp lg:relative -top-20 rounded-md lg:w-3/4 w-full h-3/5 flex flex-col-reverse lg:flex-row justify-evenly px-2 py-2 lg:space-y-0 lg:space-x-2">
